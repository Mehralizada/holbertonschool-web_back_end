...
def safely_get_value(dct: Mapping, key: Any, default: Optional[T] = None) -> Union[T, Any]:
    """
    ...
    default (Optional[T]): The default value to return if the key is not found. Defaults to None.
